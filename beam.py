delivered_table_spec = 'bigquery-demo-415906.dataset_food_orders.delivered_orders'
other_table_spec = 'bigquery-demo-415906.dataset_food_orders.other_status_orders'
...
delivered_orders = (
    cleaned_data
    | 'Delivered Filer' >> beam.Filter(lambda row: row.split(',')[8].lower() == 'delivered')
)
...
dataset_id = 'bigquery-demo-415906.dataset_food_orders'
